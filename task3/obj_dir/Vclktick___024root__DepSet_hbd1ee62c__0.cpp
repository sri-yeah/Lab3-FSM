...
VL_INLINE_OPT void Vclktick___024root___nba_sequent__TOP__1(Vclktick___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vclktick__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vclktick___024root___nba_sequent__TOP__1\n"); );
    // Body
    vlSelf->clktick__DOT__stateMachine__DOT__cstate 
        = ((IData)(vlSelf->rst) ? 0U : vlSelf->clktick__DOT__stateMachine__DOT__nstate);
    vlSelf->dout = (((((((((0U == vlSelf->clktick__DOT__stateMachine__DOT__cstate) 
                     ...
                     ? ((0U == vlSelf->clktick__DOT__stateMachine__DOT__cstate)
                         ? 0U : ((1U == vlSelf->clktick__DOT__stateMachine__DOT__cstate)
                                  ? 1U : ((2U == vlSelf->clktick__DOT__stateMachine__DOT__cstate)
                                           ? 3U : (
                                                   (3U 
                                                    == vlSelf->clktick__DOT__stateMachine__DOT__cstate)
                                                    ? 7U
...
VL_INLINE_OPT void Vclktick___024root___nba_comb__TOP__0(Vclktick___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vclktick__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vclktick___024root___nba_comb__TOP__0\n"); );
    // Body
...
void Vclktick___024root___eval_nba(Vclktick___024root* vlSelf) {
    ...
    if ((2ULL & vlSelf->__VnbaTriggered.word(0U))) {
        Vclktick___024root___nba_sequent__TOP__1(vlSelf);
    }
    if ((3ULL & vlSelf->__VnbaTriggered.word(0U))) {
        Vclktick___024root___nba_comb__TOP__0(vlSelf);
    }
}
