...
VL_ATTR_COLD void Vf1_fsm___024root__trace_full_sub_0(Vf1_fsm___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+6,(vlSelf->cmd_seq));
    bufp->fullBit(oldp+7,(vlSelf->cmd_delay));
    bufp->fullIData(oldp+8,(vlSelf->f1_fsm__DOT__cstate),32);
    bufp->fullIData(oldp+9,(vlSelf->f1_fsm__DOT__nstate),32);
}
