...
void Vf1_fsm___024root__trace_chg_sub_0(Vf1_fsm___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgBit(oldp+5,(vlSelf->cmd_seq));
    bufp->chgBit(oldp+6,(vlSelf->cmd_delay));
    bufp->chgIData(oldp+7,(vlSelf->f1_fsm__DOT__cstate),32);
    bufp->chgIData(oldp+8,(vlSelf->f1_fsm__DOT__nstate),32);
}
